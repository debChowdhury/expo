...
open class ExpoNotificationBuilder(context: Context?) : ChannelAwareNotificationBuilder(context) {
    override suspend fun build(): Notification {
        ...
        builder.setStyle(NotificationCompat.BigTextStyle().bigText(content.getText()))
        ...
        if (shouldPlaySound() && content.getSoundName() != null) {
            content.getSoundName()?.let { soundName ->
        ...
        val vibrationPatternOverride = content.getVibrationPattern()
        ...
        requestExtras.putByteArray(
            EXTRAS_MARSHALLED_NOTIFICATION_REQUEST_KEY, marshallNotificationRequest(
        ...
        builder.setContentIntent(
            createNotificationResponseIntent(
                context, notification, defaultAction
            )
        )
    ...
    private fun shouldPlaySound(): Boolean {
        ...
        val contentAllowsSound = notificationContent.shouldPlayDefaultSound() || notificationContent.getSoundName() != null
    ...
    private fun shouldVibrate(): Boolean {
        ...
        val contentAllowsVibration =
            notificationContent.shouldUseDefaultVibrationPattern() || notificationContent.getVibrationPattern() != null
    ...
    private val priority: Int
         ...
         */
        get() {
            val requestPriority = notificationContent.getPriority()
    ...
    protected val color: Number?
        ...
        get() {
            if (notificationContent.getColor() != null) {
                return notificationContent.getColor()
            }
